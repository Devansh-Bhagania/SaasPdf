...
const Razorpay = () => {
  const key_secret = 'rzp_test_v4wZXK8tUjyXFX'
        ...
        <form className=''>
          ...
          <div className='col-12 '>
            ...
            <form method="POST" action="https://api.razorpay.com/v1/checkout/embedded">
                ...
                <input type="hidden" name="order_id" value='order_N6gvnPmbqL0j3o'/>
                ...
                {!loading2? <div className='col-12 center'>
                    <button  className=' p-2 bg-blue-300 text-white w-100' type="submit">Pay Now</button>
                </div>
                :
